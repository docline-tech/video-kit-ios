#
#  Be sure to run `pod spec lint DoclineVideoSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  The iOS SDK allows you to integrate Docline video consultation services in an easy and simple way, in applications for iPad and iPhone devices.
                   DESC

  spec.homepage     = "https://docline.es"
  ...
  spec.author       = { "Aplicaciones Salud SL." => "developer@docline.es" }
